...
/**
 * DatabaseInit — создание таблиц SQLite.
 * <p>
 * Порт {@code com.mcplugin.database.DatabaseInit} из MC-Plugin.
 * Содержит все CREATE TABLE statements из оригинального плагина.
 */
public class DatabaseInit {
    ...
    public static void init() {
        try (Connection con = DatabaseManager.getConnection();
            ...
            ConsoleLogger.info("[DB] All tables initialized successfully.");

        } catch (Exception e) {
            ConsoleLogger.error("[DB] Table initialization failed: " + e.getMessage());
        }
    }
}
